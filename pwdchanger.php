...
<div class="w3-margin-left w3-container">
            ...
            <?php
                ...
                if(isset($_POST['chg'])){
                    $oldpass=$_POST['opass'];
                    $newpass=$_POST['npass'];
                    $query="SELECT cust_id from customer where cust_password='$oldpass'";
                    $exe=mysqli_query($conn,$query);
                    $res=mysqli_num_rows($exe);
                    $rows=mysqli_fetch_assoc($res);
                    if($res==1){
                        $chng="UPDATE customer SET cust_password='$newpass' WHERE cust_password='$oldpass'";
                ...
                <div class="w3-container w3-round-xlarge w3-white w3-margin-left w3-margin-right">
                    ...
                    <form method=POST action="#">
                        <table>
                            ...
                            <tr>
                                <td colspan="2"><button class="button" style="vertical-align:middle" name="chg"><span>Confirm</span></button></td>
                            </tr>
                        </table>
                    </form>
                    <br>
